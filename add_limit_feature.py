...
# -*- coding: utf-8 -*-
"""
Script pour ajouter la fonctionnalité --limit à l'application
...
def create_main_with_limit():
    """Crée un main_limited.py qui supporte --limit"""
    
    print("Création de main_limited.py avec support de --limit...")
...
'''
    ...
    with open('main_limited.py', 'w', encoding='utf-8') as f:
        f.write(content)
    
    print("[OK] main_limited.py créé avec succès!")
    print("\nPour l'utiliser:")
    print("  python main_limited.py --limit 30")
    print("  python main_limited.py --limit 30 --no-transcription")
    
    # Remplacer main.py automatiquement
    ...
    # Remplacer
    shutil.copy2('main_limited.py', 'main.py')
    print("[OK] main.py remplacé avec succès!")

if __name__ == "__main__":
    print("=== Ajout de la fonctionnalité --limit ===\n")
    create_main_with_limit()
